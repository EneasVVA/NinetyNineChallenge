...
object AndroidClient {
    const val appId = "com.eneasmacias.challange"
...
object Libraries {
    private object Versions {
        ...
        const val store = "3.1.1"
        const val rxJava = "2.1.1"
        const val rxAndroid = "2.1.1"
        const val rxCache = "1.1.3-2.x"
        const val rxCacheGson = "0.0.4"
    }
    ...
    const val store = "com.nytimes.android:store3:${Versions.store}"
    const val rxJava = "io.reactivex.rxjava2:rxjava:${Versions.rxJava}"
    const val rxAndroid = "io.reactivex.rxjava2:rxandroid:${Versions.rxAndroid}"
    const val retrofitRxAdapter = "com.squareup.retrofit2:adapter-rxjava2:${Versions.retrofitRxAdapter}"
    const val rxCache = "com.github.VictorAlbertos:ReactiveCache:${Versions.rxCache}"
    const val rxCacheGson = "com.github.VictorAlbertos.Jolyglot:gson:${Versions.rxCacheGson}"
