...
tasks.register("runApp", Exec::class) {
    ...
    if (localProperties.exists()) {
        ...
        val applicationPackage = "com.eneasmacias.challange.${Default.BUILD_FLAVOR}.${Default.BUILD_TYPE}"
        val launchActivity = "com.eneasmacias.challange.core.navigation.RouteActivity"
